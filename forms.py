...
class SearchForm(forms.Form):
	Gender_list = ['Select','Male','Female','Both']
	Stage_list = ['Select','Stage I','Stage II','Stage III','Stage IV','Stage X','Stage IA','Stage IIA','Stage IIIA','Stage IVA','Stage IB','Stage IIB','Stage IIIB','Stage IVB','Stage IC','Stage IIC','Stage IIIC','Stage IVC']
	Grade_list = ['Select','Grade 1','Grade 2','Grade 3','Grade 4','Grade I','Grade II','Grade III','Grade IV']
